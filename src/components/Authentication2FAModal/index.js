...
class Authentication2FAModal extends Component {
  ...
  onClose = async () => {
    ...
    await store.dispatch(
      setModal({ key: "Authentication2FAModal", value: false })
    );
  };
  ...
  render() {
    ...
    if (!modal.Authentication2FAModal) {
      return null;
    }
    return (
      <Modal onClose={this.onClose}>
        ...
        >
          <div>
            <Typography variant="body" color={"grey"} weight={"bold"}>
              {" "}
                  ...
                  },
                  {
                    ...
                    content: (
                      <div styleName="token2FA">
                        <Input2FA
                          secret={`secret`}
                          confirm={this.set2FAAuthenticator}
                        />
                      </div>
                    ),
                    last: true,
