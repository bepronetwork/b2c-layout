  ...
  projectData = async (props) => {
    try {
      ...
      if (user) {
        ...
        if (points) {
          let differencePoints = formatCurrency(
      ...
      <div>
        <div styleName="currency-selector">
          ...
          <div styleName="button-deposit">
            <button
              onClick={() => onMenuItem({ history, path: "/settings/wallet" })}
              type="submit"
              styleName="button"
            >
              <Typography
        ...
        {isValidPoints == true ? (
          <div styleName="points">
            <PrimaryTooltip
              title={`${formatCurrency(currentPoints)} ${namePoints}`}
            >
            ...
            {differencePoints ? (
              <div key={currentPoints} styleName={"diff-won"}>
                <Typography variant="small-body">
  ...
  renderLanguageProfile = () => {
    ...
    return (
      <div styleName="language-profile">
        {user ? this.renderProfileMenu() : this.renderLoginOrRegister()}
        {this.renderLanguageSelector()}
        {user ? this.renderSettings() : null}
      </div>
    );
  };
