              ...
              {this.state.slides.map((slider, index) => {
                return (
                  <div styleName={slider.class} key={index}>
                    ...
                    <div
                      styleName="slider-single-content"
                      onMouseOver={() => this.onMouseOverElement(true)}
                      onMouseOut={() => this.onMouseOverElement(false)}
                    >
                      {slider.element}
                    </div>
                  </div>
