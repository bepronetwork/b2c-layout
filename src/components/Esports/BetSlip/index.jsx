...
class BetSlip extends Component {
          ...
          const errorMessage =
            message && !_.isEmpty(message)
              ...
              ? "Error to bet on '" +
                ...
                bet.title +
                "'."
              : "Error in one or more matches in the multiple bet.";
  ...
  render() {
    ...
    const hasInvalidOdd = !_.isEmpty(betSlip)
      ? !!betSlip.find(
          (bet) => bet.marketActive !== undefined && bet.marketActive === false,
        )
      : false;
          ...
          <div>
            ...
            <div>
              ...
              <div styleName="bet-slip">
                    ...
                    <div styleName="multiple-info">
                      {isSuccessBet === true ? (
                        ...
                        <InputNumber
                          ...
                          max={
                            user && !_.isEmpty(user) ? user.getBalance() : null
                          }
                          value={amount}
                ...
                {tab === "multiple" &&
                this.hasMultipleBetOpponnetsInSameMatch() ? (
                  <div styleName="error">
