        ...
        return (
            <div styleName="more">
                <div styleName="top-row">
                    <Typography variant={'small-body'} weight={'bold'} color={'white'}>Select your tournaments</Typography>
                </div>
                                        ...
                                        <div styleName="more-series">
                                            <ul>
                                            {
                                                game.series.map(serie => {
                                                    ...
                                                    return (
                                                        <li styleName={styles} onClick={() => this.handleFilterClick(serie.id)} >
                                                            <div styleName="tournament-name">
                                                                <Typography variant={'x-small-body'} color={'white'}>{`${serie.league.name} - ${serie.full_name}`}</Typography>
                                                            </div>
                                                        </li>
                                                    )
                                                })
                ...
                <div styleName="bottom-row">
                    <Button size={'x-small'} theme="primary" onClick={() => this.handleSaveFilterClick()}>
                        <Typography color={'fixedwhite'} variant={'x-small-body'}>Save my filters</Typography>
                    </Button>
                </div>
            </div>
        );
