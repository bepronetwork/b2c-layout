...
class Stats extends Component {
  ...
  projectData = async (props) => {
    ...
    this.setState({
      stats1:
        hasPlayers === true
          ? await this.formatStatsByDate(team1.stats, stats1)
          : stats1,
      stats2:
        hasPlayers === true
  ...
  async formatStatsByDate(stats, teamStats) {
    ...
    stats.map((s) => {
      ...
      if (
        moment(oneYearAgoDate).isBefore(endDate) ||
  ...
  renderHistoryPerformance() {
    ...
    do {
      ...
      const performance1 =
        sumPlayed1 > 0 ? (sumWon1 / sumPlayed1) * 100 : "N/A";
      const performance2 =
  ...
  render() {
    ...
    return (
      <div styleName="stats-menu">
        ...
        <div>{this.renderHistoryPerformance()}</div>
      </div>
    );
  }
}
