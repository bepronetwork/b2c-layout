...
class DepositForm extends Component {
  ...
  projectData = async props => {
    ...
    const isDepositBonus = getAddOn().depositBonus
      ? getAddOn().depositBonus.isDepositBonus
      : false;
            ...
            <div styleName="info">
              ...
              <div styleName="qrcode">
                <QRCode
                  value={address}
                  bgColor={
                    skin.skin_type == "digital" ? backgroundColor.hex : "#fff"
                  }
                  fgColor={
                    skin.skin_type == "digital" ? secondaryColor.hex : "#000"
                  }
                />
              </div>
              {copied ? (
              ...
              {isValidFree ? (
                <CurrencyFreeMoney
                  ...
                  minutes={minutes}
                  seconds={seconds}
                  title={copy.INDEX.TYPOGRAPHY.FREE_TITLE[0](
                    [wallet.currency.ticker],
                    staticHour,
                    staticMinute
                  )}
