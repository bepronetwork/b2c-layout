...
class SecurityTab extends React.Component {
  ...
  projectData = (props) => {
    ...
    let has2FA = profile.user.hasOwnProperty("security")
      ? profile.user.security.hasOwnProperty("2fa_set")
        ? profile.user.security["2fa_set"]
        : false
      : false;
  ...
  handle2FAAuthenticationToggle = async () => {
    ...
    if (has2FA) {
      ...
      await store.dispatch(
        setModal({ key: "Authentication2FAModal", value: true })
      );
    }
        ...
        <div styleName="field">
          <div styleName="label">
            <Typography variant={"small-body"} color={"white"}>
              {copy.INDEX.TOGGLE_FORM.TITLE[1]}
            </Typography>
          </div>
          <div styleName="value">
            <Toggle
            ...
            <div styleName="value">
              ...
              >
                <Typography
                  variant={"small-body"}
                  color={
                    skin.skin_type == "digital" ? "secondary" : "fixedwhite"
                  }
                >
                  {copyConfirmEmail.CONTAINERS.APP.MODAL[2]}
                </Typography>
