    ...
    return (
      <Container styleName="dashboard">
        <Tab.Container
          ...
          defaultActiveKey={`item-${mainIndex}`}
        >
          <Row>
                ...
                {filteredItems.map((item, index) => {
                  ...
                  return (
                    <Nav.Item key={item.title}>
                      <Nav.Link
                        as={Link}
                        to={"/" + parent + "/" + item.path.toLowerCase()}
                        eventKey={`item-${index}`}
                      >
                        <div styleName={styles}>
                          ...
                          <div styleName="text-tab">
                            <Typography
                              variant={"small-body"}
                              color={
                                mainIndex === index ? "secondary" : "white"
                              }
                            >
                              {item.title}
                            </Typography>
                ...
                {filteredItems.map((item, index) => {
                  return (
                    <Tab.Pane eventKey={`item-${index}`}>
                      <div styleName="content">{item.container}</div>
                    </Tab.Pane>
                  );
                })}
              </Tab.Content>
