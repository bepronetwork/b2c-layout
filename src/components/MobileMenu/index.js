...
class MobileMenu extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            ...
            points: 0,
            itens : [
                { path: "/settings/account",        copyValue: 6,                                       icon: userIcon === null ? <UserIcon /> : <img src={userIcon} alt="User" /> },
                { path: "/settings/security",       copyValue: 7,                                       icon: securityIcon === null ? <ConfirmedIcon /> : <img src={securityIcon} alt="Security" /> },
                { path: "/settings/bets",           copyValue: 5,                                       icon: betsIcon === null ? <BetsIcon /> : <img src={betsIcon} alt="Bets" /> },
                { path: "/settings/wallet",         copyValue: 8,                                       icon: walletIcon === null ? <WalletIcon /> : <img src={walletIcon} alt="Wallet" /> },
                { path: "/settings/deposits",       copyValue: getApp().virtual === true ? 4 : 1,       icon: depositsIcon === null ? <DepositsIcon /> : <img src={depositsIcon} alt="Deposits" /> },
                { path: "/settings/withdraws",      copyValue: 2,                                       icon: withdrawIcon === null ? <WithdrawIcon /> : <img src={withdrawIcon} alt="Withdraw" /> },
                { path: "/settings/affiliate",      copyValue: 3,                                       icon: affiliatesIcon === null ? <UsersIcon /> : <img src={affiliatesIcon} alt="Affiliates" /> },
                { path: "/settings/preferences",    copyValue: 9,                                       icon: preferencesIcon === null ? <SettingsIcon /> : <img src={preferencesIcon} alt="Preferences" /> },
            ],
            tabs: []
        }
    }
                        ...
                        return (
                            <div key={t.name}>
                                <a styleName="title" href={blankBool ? t.link_url : null} onClick={() => this.homeClick(t.link_url)} target={blankBool ? "_blank" : null} rel="noopener">
                                    ...
                                    ?
                                        <div styleName='img'>
                                            <img src={t.icon} width="22" height="22" alt={t.name}/>
                                        </div>
