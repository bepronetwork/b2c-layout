...
class Form extends Component {
    ...
    this.setState({
      ...
      maxBalance: formatCurrency(
        appWallet.max_withdraw > wallet.playBalance
          ? wallet.playBalance
          : appWallet.max_withdraw,
      ),
      minBalance: formatCurrency(
        appWallet.min_withdraw > wallet.playBalance
          ? wallet.playBalance
          : appWallet.min_withdraw,
      ),
  ...
  render() {
    ...
    const percenteToBonus =
      100 * (incrementBetAmountForBonus / minBetAmountForBonusUnlocked);
          ...
          <div styleName="box">
            ...
            <div>
              <button
                ...
                styleName="withdraw"
                disabled={bonusAmount > 0 || disabled || isAsking}
              >
                {isAsking ? (
