...
class BetsTab extends Component {
  ...
  projectData = async (props, options = null) => {
    ...
    this.setState({
      ...
      esportsGames,
      gamesOptions:
        view === "casino" ? casinoGamesOptions : esportsGamesOptions,
      casinoGamesOptions,
      esportsGamesOptions,
      casinoRows,
      esportsRows,
      ...
      options: Object.keys(copy.TABLE)
        .filter(
          (key) => key !== "ESPORTS" || (key === "ESPORTS" && isEsportsEnabled),
        )
        .map((key) => {
          return {
  ...
  handleTabChange = async (name) => {
    ...
    this.setState({
      view: name,
      gamesOptions:
        name === "casino" ? casinoGamesOptions : esportsGamesOptions,
      ...
      <div styleName="container">
        ...
        <Table
          ...
          games={games
            .filter(function(g) {
              return (
                view_game.value === "all_games" ||
                g.metaName === view_game.value
              );
            })
            .map(function(g) {
              return g;
