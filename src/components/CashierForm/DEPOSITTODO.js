                            ...
                            steps={[
                                {
                                    ...
                                    content : 
                                        (
                                            <div>
                                                <PaymentBox image={currencies.ethereum} type={'Ethereum'} description={'Ethereum Description'} time={'2 minutes'} />
                                                <PaymentBox image={currencies.dai} type={'DAI'} description={'DAI Description'} time={'1 minute'} />
                                            </div>
                                        )
