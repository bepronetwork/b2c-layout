      ...
      return (
        <div>
          <Typography color={"white"} variant={"body"}>
            {" "}
            {copy.DEPOSITSTABLE.TYPOGRAPHY.TEXT[0]}{" "}
          </Typography>
          <Typography color={"casper"} variant={"small-body"}>
            {" "}
            {copy.DEPOSITSTABLE.TYPOGRAPHY.TEXT[1]}{" "}
          </Typography>
        </div>
      );
    }
                    ...
                    >
                      ...
                      >
                        {n.isConfirmed ? (
                          <div
                            styleName={
                              withdrawStatus[n.confirmed.toLowerCase()]
                            }
                          >
                            <Typography variant={"small-body"} color="white">
                              {n.confirmed}
...
export default compose(connect(mapStateToProps))(
  withStyles(styles)(DepositsTable)
);
