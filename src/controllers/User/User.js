...
export default class User {
  constructor({ platformAddress, tokenAddress, decimals, appId, user, app }) {
    // Logged
    this.id = user.id;
  ...
  updateBalance = async ({ userDelta, amount }) => {
    ...
    if (
      this.app.addOn.pointSystem &&
      this.app.addOn.pointSystem.isValid == true &&
      amount
    ) {
