...
class ResetPassword extends Component {
    ...
    onUserChange = event => {
        this.setState({ user: event.target.value, disabled : !_.isEmpty(event.target.value) ? false : true});
    };
    ...
    onPasswordChange = event => {
        ...
        if(!_.isEmpty(event.target.value) && event.target.value === confirmPassword){
            disabled = false;
        }
