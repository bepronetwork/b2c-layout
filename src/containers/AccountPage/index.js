          ...
          <TabedContainer
            items={[
              ...
              },
              {
                ...
                container: (
                  <WalletTab isCurrentPath={this.isCurrentPath("wallet")} />
                ),
                icon:
                  walletIcon === null ? (
                    <WalletIcon />
              ...
              },
              {
                path: "deposits",
                title: virtual
                  ? copy.CONTAINERS.ACCOUNT.TITLE[4]
                  : copy.CONTAINERS.ACCOUNT.TITLE[1],
                container: (
                  <DepositTab isCurrentPath={this.isCurrentPath("deposits")} />
                ),
                icon:
                  depositsIcon === null ? (
                    <DepositsIcon />
              ...
              },
              {
                ...
                container: (
                  <WithdrawTab
                    isCurrentPath={this.isCurrentPath("withdraws")}
                  />
                ),
                icon:
                  withdrawIcon === null ? (
              ...
              },
              {
                ...
                container: (
                  <AffiliatesTab
                    isCurrentPath={this.isCurrentPath("affiliate")}
                  />
                ),
                icon:
                  affiliatesIcon === null ? (
