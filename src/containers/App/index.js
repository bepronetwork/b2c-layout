...
class App extends Component {
  ...
  handleLogin = async form => {
    try {
      ...
      if (response.status != 200) {
        const has2FA = response.status === 37 ? true : false;
  ...
  handleRegister = async form => {
    try {
      ...
      if (user) {
        ...
        const bearerTokenApi = bearerToken;

        Promise.all(
          currenciesMap.map(async ({ id }) => {
            const currency = id;
        ...
        <div styleName="modal modal-login">
          ...
          {registerLoginModalOpen === "login" ? (
            <LoginForm
              ...
              error={error}
              has2FA={has2FA}
              onClose={this.handleRegisterLoginModalClose}
      ...
      <Modal onClose={this.handleResetPasswordModalClose}>
        <div styleName="modal">
          ...
          <ResetPassword
            ...
            onClose={this.handleResetPasswordModalClose}
          />
        </div>
      </Modal>
    ) : null;
      ...
      <Modal onClose={this.handleConfirmEmailModalClose}>
        <div styleName="modal">
          ...
          <ConfirmEmail
            ...
            onClose={this.handleConfirmEmailModalClose}
          />
        </div>
      </Modal>
    ) : null;
    ...
    if (tableDetailsOpen) {
      ...
      return (
        <Modal onClose={this.handleTableDetailsModalClose}>
          <BetDetails
            onClose={this.handleTableDetailsModalClose}
  ...
  render() {
    ...
    const progress100 = parseInt((progress / confirmations) * 100);
    const isUserLoaded = confirmations == progress;
        ...
        <Router history={history}>
          ...
          <div>
            ...
            <div styleName="main">
                      ...
                      render={props => (
                        <HomePage
                          ...
                          onHandleLoginOrRegister={
                            this.handleLoginOrRegisterOpen
                          }
                          onTableDetails={this.handleTableDetailsOpen}
                          history={history}
                        />
              ...
              {cripsr && cripsr.key ? (
                <div
                  styleName="chat-crisp-expand chat-crisp-expand-mobile"
                  onClick={this.openCripsrChatClick}
                >
                  <div>
                    {liveChatIcon === null ? (
                      <LiveChatIcon />
