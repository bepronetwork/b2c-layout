    ...
    projectData = async (props, options=null) => {
        ...
        this.setState({
            ...
            options : Object.keys(copy.TABLE).map( (key) => {
                ...
                if(value === "all_bets"){
                    icon = allBetsIcon === null ? <CheckIcon/> : <img src={allBetsIcon} alt="All Bets" />;
                }
                else if(value === "my_bets"){
                    icon = <RewardIcon/>;
                }
                else if(value === "biggest_win_bets"){
                    icon = biggestWinsIcon === null ? <TrophyIcon/> : <img src={biggestWinsIcon} alt="Biggest Wins" />;
                }
                else if(value === "biggest_win_users"){
                    icon = leaderBoarderIcon === null ? <AffiliateIcon/> : <img src={leaderBoarderIcon} alt="Leader Boarder" />;
                }
