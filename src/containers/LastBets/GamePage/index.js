    ...
    projectData = async (props, options=null) => {
        ...
        this.setState({
            ...
            options : Object.keys(copy.TABLE).map( (key) => {
                ...
                if(value === "all_bets"){
                    icon = latestWinsIcon === null ? <RewardIcon /> : <img src={latestWinsIcon} alt="Reward" />;
                }
                else if(value === "my_bets"){
                    icon = latestBetsIcon === null ? <CheckIcon /> : <img src={latestBetsIcon} alt="Check" />;
                }
                else if(value === "biggest_win_bets"){
                    icon = biggestWinsIcon === null ? <TrophyIcon /> : <img src={biggestWinsIcon} alt="Trophy" />;
                }
