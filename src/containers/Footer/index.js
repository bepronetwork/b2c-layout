                ...
                <div styleName="footer">
                                    ...
                                    <div styleName={tab.align}>
                                        ...
                                        {tab.items.map( col => {
                                            switch(col.type){
                                                ...
                                                case 'image' : 
                                                    return <img src={col.image} style={{width : col.width}} key={col.text} alt={col.text} />
                                                case 'text' : 
                                                    return (
                        ...
                        <Row>
                            <div className="col-md-2" styleName="col">
                                <a href={'https://www.bitgo.com'} target={'_blank'}>
                                    <img src={ getAppCustomization().theme === 'dark' ? logobBitGo_dark : logobBitGo_light } style={{height : 40}} alt="Partner" />
                                </a>
                            </div>
                            <div className="col-md-2" styleName="col">
                                <a href={'https://betprotocol.com'} target={'_blank'}>
                                    <img src={ getAppCustomization().theme === 'dark' ? logoBetProtocol_dark : logoBetProtocol_light } style={{height : 46}} alt="Partner" />
                                </a>
                            </div>
                            <div className="col-md-2" styleName="col">
                                <a href={'https://bitcoin.org'} target={'_blank'}>
                                    <img src={ getAppCustomization().theme === 'dark' ? logoBitCoin_dark : logoBitCoin_light } style={{height : 40}} alt="Partner" />
                                </a>
                            </div>
                            <div className="col-md-2" styleName="col">
                                <a href={'https://ethereum.org'} target={'_blank'}>
                                    <img src={ getAppCustomization().theme === 'dark' ? logoEthereum_dark : logoEthereum_light } style={{height : 26}} alt="Partner" />
                                </a>
                            </div>
                            <div className="col-md-2" styleName="col">
                                <a href={'https://www.begambleaware.org'} target={'_blank'}>
                                    <img src={ getAppCustomization().theme === 'dark' ? logoResponsible_dark : logoResponsible_light } style={{height : 30}} alt="Partner" />
                                </a>
                            </div>
                            <div className="col-md-2" styleName="col">
                    ...
                    <div styleName='footer-logo'>
                        <Row>
                            ...
                            <div className="col-md-3" styleName="col">
                                <a href={'https://betprotocol.com'} target={'_blank'}>
                                    <img src={ getAppCustomization().theme === 'dark' ? logoMadeByBepro_dark : logoMadeByBepro_light } styleName='bepro-made-by-logo' alt="Made by" />
                                </a>
                            </div>
                        </Row>
                    </div>
